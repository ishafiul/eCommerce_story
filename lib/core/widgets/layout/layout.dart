      ...
      headerSliverBuilder: (context, innerBoxIsScrolled) => [
        if (appBar != null)
          SliverAppBar(
            ...
            backgroundColor: appBar?.flexibleSpace != null ? Colors.grey.shade50 : appBar?.appbarColor,
            floating: true,
            pinned: true,
            shape: ContinuousRectangleBorder(borderRadius: appBar?.borderRadius ?? BorderRadius.zero),
